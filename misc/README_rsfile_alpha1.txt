...
Since the primary goal of this release is to stabilize the API, you're 
highly invited to browse the doc below, and to send feedback on method 
names, advanced mode flags, wished functionalities etc.
