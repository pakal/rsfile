...
# Generated by command generate_win32_wrappers.py -s SECURITY_ATTRIBUTES -s OVERLAPPED -s BY_HANDLE_FILE_INFORMATION -s GetLastError -s CreateFileA -s CreateFileW -s _open_osfhandle -s _get_osfhandle -s CloseHandle -s SetEndOfFile -s GetFileInformationByHandle -s GetFileSize -s GetFileSizeEx -s SetFilePointer -s SetFilePointerEx -s ReadFile -s ReadFileEx -s WriteFile -s WriteFileEx -s FlushFileBuffers -s LockFileEx -s UnlockFileEx -o ../raw_win32_cython.c windows.h windows.c.xml
...
cdef extern from 'windows.h':
	...
	ctypedef long unsigned int DWORD
	ctypedef long int LONG
	cdef struct N14_LARGE_INTEGER3DOLLAR_1E:
		DWORD LowPart
		LONG HighPart
	cdef struct N14_LARGE_INTEGER3DOLLAR_2E:
		DWORD LowPart
		LONG HighPart
	ctypedef long long int LONGLONG
	cdef union _LARGE_INTEGER:
		N14_LARGE_INTEGER3DOLLAR_1E 
		N14_LARGE_INTEGER3DOLLAR_2E u
		LONGLONG QuadPart
		N14_LARGE_INTEGER3DOLLAR_1E
		N14_LARGE_INTEGER3DOLLAR_2E
	...
	ctypedef long unsigned int ULONG_PTR
	cdef struct N11_OVERLAPPED4DOLLAR_814DOLLAR_82E:
		DWORD Offset
		DWORD OffsetHigh
	ctypedef void * PVOID
	cdef union N11_OVERLAPPED4DOLLAR_81E:
	...
	cdef struct _OVERLAPPED:
		...
		N11_OVERLAPPED4DOLLAR_81E 
		HANDLE hEvent
	ctypedef _OVERLAPPED * LPOVERLAPPED
	BOOL WriteFile(HANDLE, LPCVOID, DWORD, LPDWORD, LPOVERLAPPED)
	ctypedef void * LPVOID
	ctypedef void(*LPOVERLAPPED_COMPLETION_ROUTINE)(DWORD, DWORD, LPOVERLAPPED)
	...
	cdef struct _BY_HANDLE_FILE_INFORMATION:
		...
		DWORD nFileIndexLow
	ctypedef _BY_HANDLE_FILE_INFORMATION * LPBY_HANDLE_FILE_INFORMATION
